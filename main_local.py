"""
FastAPI LOCAL - Auditoría de Tiendas (SQLite)
Para uso con Cloudflare Tunnel
"""
import io
import json
import os
...
# Importar funciones de database_local.py (SQLite)
...
app = FastAPI(title="En los zapatos del cliente [LOCAL]")
templates = Jinja2Templates(directory="templates")
security = HTTPBasic()

# Credenciales dashboard (puedes cambiarlas)
...
def on_startup() -> None:
    ...
    print("[+] Servidor LOCAL corriendo con SQLite")
    print("[+] Base de datos: auditoria_local.db")
...
def recibir_punto_compra(
    ...
    """Recibe evaluación punto de compra."""
    insertar_punto_compra({
        "nombre": nombre,
        "tienda": tienda,
...
def recibir_visita(
    ...
    """Recibe formulario Visitas con Sentido."""
...
def eliminar_pc(
    ...
    """Elimina evaluación punto de compra."""
